...
This repository contains two different kinds of thing, with different terms.
...
psiu.org at their existing addresses; this site links to them and streams them.

## The build scripts

Everything under `build/`, plus `site/assets/css/`, `site/assets/js/` and the
workflow in `.github/`, is ordinary software and may be reused freely, with or
without attribution.

## Third-party components

`site/vendor/pdfjs/` is [PDF.js](https://mozilla.github.io/pdf.js/) by Mozilla,
Apache License 2.0 — the licence text is included in that folder.

The search index is built with [Pagefind](https://pagefind.app/), MIT licence.
